...
- (void)viewDidLoad
{
    ...
    if ([self.typeString isEqualToString:@"Privacy Policy"]) {
        ...
        webUrl = [NSURL URLWithString:@"http://104.236.104.6/tindercloneApp/app/privacy.php"];
    }
    else if ([self.typeString isEqualToString:@"Terms of Service"]) {
        
        webUrl = [NSURL URLWithString:@"http://104.236.104.6/tindercloneApp/app/terms.php"];
    }
