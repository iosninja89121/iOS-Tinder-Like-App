...
-(IBAction)onClickBtn:(id)sender
{
    ...
    {
        UIActionSheet *as=[[UIActionSheet alloc]initWithTitle:nil delegate:self cancelButtonTitle:@"Cancel" destructiveButtonTitle:nil otherButtonTitles:@"Open camera",@"Choose from libaray", nil];
