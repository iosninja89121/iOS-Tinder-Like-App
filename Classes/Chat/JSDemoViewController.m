...
- (void)btnMorePressed:(UIBarButtonItem *)sender
{
    ...
    UIActionSheet *actionSheet = [[UIActionSheet alloc] initWithTitle:nil
                                                    ...
                                                    otherButtonTitles:[NSString stringWithFormat:@"Unmatch %@",friendName],[NSString stringWithFormat:@"Report %@",friendName],@"Delete Message",@"Take Photo",@"Send Gallery Photo", nil];
